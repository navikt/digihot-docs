...
data class Tilleggsinfo (
    ...
    /**
     * 
     * Values: RULLESTOL_SKAL_BRUKES_I_BIL,SITTEPUTEVALG_STANDARD_SITTEPUTE,SITTEPUTEVALG_LEGGES_TIL_SEPARAT,SITTEPUTEVALG_HAR_FRA_FOR,SITTEPUTEVALG_TRENGER_SITTEPUTE,LAVERE_RANGERING_BEGRUNNELSE,KAN_IKKE_HA_TILSVARENDE_BEGRUNNELSE,PERSONLOFTER_VALG_HAR_BEHOV_FOR_SEIL_ELLER_SELE,ANNEN_KOMMENTAR
     */
    enum class Key(val value: kotlin.String) {
        ...
        @Json(name = "PERSONLOFTER_VALG_HAR_BEHOV_FOR_SEIL_ELLER_SELE") PERSONLOFTER_VALG_HAR_BEHOV_FOR_SEIL_ELLER_SELE("PERSONLOFTER_VALG_HAR_BEHOV_FOR_SEIL_ELLER_SELE"),
